...
public:
    ...
    static Eigen::Vector3f cvPinholeToNED(const Eigen::Vector3f &vPinhole);
    static Eigen::Vector4f cvPinholeToNED(const Eigen::Vector4f &vPinhole);
    static Eigen::Matrix4f cvPinholeToNED(const Eigen::Matrix4f &mPinhole);
};
