...
void Atlas::GenerateNewOccupancyGrid(const int n_mappoint_obs_min, const int n_mappoint_max_dst) {
    ...
    auto pOG = std::make_shared<OccGrid>(this, 0.05f, n_mappoint_obs_min, n_mappoint_max_dst);
